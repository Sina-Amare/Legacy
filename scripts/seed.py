...
# All text fields, including descriptions and briefs, are complete and final.
INITIAL_DATA = {
    "dynasties": [
    ...
    "decision_options": [
        {"id": 1, "node_id": 1, "option_text": "[نظامی] زمان قیام است! سپاه پارس را برای جنگ با مادها آماده می‌کنم.", "effects": {"stability": -20, "military_strength": 15, "treasury": -300}, "next_node_id": None},
        {"id": 2, "node_id": 1, "option_text": "[دیپلماسی] به هگمتانه می‌روم. باید به آستیاگ اطمینان دهم.", "effects": {"stability": 10, "military_strength": -5}, "next_node_id": None},
        {"id": 3, "node_id": 1, "option_text": "[توطئه] با اشراف ناراضی ماد ارتباط برقرار می‌کنم تا او را از درون تضعیف کنند.", "effects": {"stability": -5, "treasury": -50}, "next_node_id": None},
        {"id": 4, "node_id": 1, "option_text": "[اقتصادی] با ارسال هدایای گران‌بها، سعی در خریدن زمان و تقویت پارس می‌کنم.", "effects": {"stability": 5, "treasury": -150}, "next_node_id": None},
        {"id": 5, "node_id": 2, "option_text": "[جنگ پارتیزانی] با جنگ‌های غافلگیرانه، خطوط تدارکاتی سلوکیان را قطع می‌کنم.", "effects": {"military_strength": 15, "treasury": -100}, "next_node_id": None},
        {"id": 6, "node_id": 2, "option_text": "[دیپلماسی] خود را به عنوان یک ساتراپ خودمختار اما وفادار به سلوکیان معرفی می‌کنم.", "effects": {"stability": 15, "military_strength": -10}, "next_node_id": None},
        {"id": 7, "node_id": 2, "option_text": "[اتحاد] با باکتریا و دیگر ساتراپی‌های شرقی که از سلوکیان ناراضی هستند، پیمان اتحاد می‌بندم.", "effects": {"stability": 5, "military_strength": 5}, "next_node_id": None},
        {"id": 8, "node_id": 2, "option_text": "[عقب‌نشینی] به سرزمین‌های شرقی عقب‌نشینی کرده و منتظر فرصت بهتر می‌مانم.", "effects": {"stability": -15, "treasury": -50}, "next_node_id": None},
        {"id": 9, "node_id": 3, "option_text": "[تمرکزگرایی دینی] با اعلام دین زرتشتی به عنوان دین رسمی، پایه‌های ایدئولوژیک حکومت را محکم می‌کنم.", "effects": {"religious_influence": 20, "stability": -15}, "next_node_id": None},
        {"id": 10, "node_id": 3, "option_text": "[پاکسازی سیاسی] اشراف قدرتمند پارتی که هنوز وفاداری کامل ندارند را حذف می‌کنم.", "effects": {"stability": 20, "treasury": -100}, "next_node_id": None},
        {"id": 11, "node_id": 3, "option_text": "[اصلاحات اقتصادی] با ضرب سکه‌های جدید و اصلاحات مالی، وضعیت اقتصادی مردم را بهبود می‌بخشم.", "effects": {"treasury": 150, "stability": 10}, "next_node_id": None},
        {"id": 12, "node_id": 3, "option_text": "[نمایش قدرت نظامی] با یک لشکرکشی سریع به مرزهای روم، هم غنیمت به دست می‌آورم و هم قدرت خود را به نمایش می‌گذارم.", "effects": {"military_strength": 15, "treasury": 100, "stability": -10}, "next_node_id": None},
        {"id": 13, "node_id": 4, "option_text": "[تحکیم قدرت مرکزی] ابتدا جایگاه خود را در تبریز محکم کرده و یک دولت مرکزی قدرتمند ایجاد می‌کنم.", "effects": {"stability": 20, "treasury": -50}, "next_node_id": None},
        {"id": 14, "node_id": 4, "option_text": "[حذف تهدید] فوراً به تعقیب بقایای آق‌قویونلوها پرداخته و تهدید آن‌ها را برای همیشه از بین می‌برم.", "effects": {"military_strength": 10, "stability": -10}, "next_node_id": None},
        {"id": 15, "node_id": 4, "option_text": "[یکپارچگی ایدئولوژیک] با تمام قوا، مذهب تشیع را در سراسر ایران گسترش می‌دهم تا یک هویت یکپارچه ایجاد کنم.", "effects": {"religious_influence": 25, "stability": -15}, "next_node_id": None},
        {"id": 16, "node_id": 4, "option_text": "[دیپلماسی خارجی] با ارسال سفیر به اروپا، به دنبال متحدی علیه امپراتوری قدرتمند عثمانی می‌گردم.", "effects": {"treasury": -50, "military_strength": 5}, "next_node_id": None},
        {"id": 17, "node_id": 5, "option_text": "[پاسخ نظامی] با لشکرکشی به قفقاز، حاکمیت ایران بر گرجستان را با قدرت به کرسی می‌نشانم.", "effects": {"military_strength": 10, "treasury": -300, "stability": -10}, "next_node_id": None},
        {"id": 18, "node_id": 5, "option_text": "[اخطار دیپلماتیک] با ارسال یک اولتیماتوم به ایراکلی و دربار روسیه، خواستار تمکین او می‌شوم.", "effects": {"stability": 5, "military_strength": -5}, "next_node_id": None},
        {"id": 19, "node_id": 5, "option_text": "[تمرکز داخلی] گرجستان را نادیده گرفته و تمام تمرکز خود را بر روی یکپارچگی و بازسازی داخلی ایران می‌گذارم.", "effects": {"stability": 15, "treasury": 50}, "next_node_id": None},
        {"id": 20, "node_id": 5, "option_text": "[ایجاد تفرقه] با حمایت از رقبای داخلی ایراکلی در گرجستان، سعی در بی‌ثبات کردن حکومت او می‌کنم.", "effects": {"treasury": -100, "stability": -5}, "next_node_id": None},
        {"id": 21, "node_id": 6, "option_text": "[ایجاد ارتش نوین] اولین اولویت، ایجاد یک ارتش ملی یکپارچه و قدرتمند برای پایان دادن به ناامنی است.", "effects": {"military_strength": 150, "treasury": -400, "stability": 10}, "next_node_id": None},
        {"id": 22, "node_id": 6, "option_text": "[اصلاحات قضایی] با ایجاد یک سیستم دادگستری مدرن، کاپیتولاسیون را لغو کرده و حاکمیت ملی را بازمی‌گردانم.", "effects": {"stability": 20, "religious_influence": -10}, "next_node_id": None},
        {"id": 23, "node_id": 6, "option_text": "[توسعه زیرساخت] تمام منابع را بر روی ساخت راه‌آهن سراسری و جاده‌ها برای اتصال کشور متمرکز می‌کنم.", "effects": {"treasury": -250, "stability": 10}, "next_node_id": None},
        {"id": 24, "node_id": 6, "option_text": "[سرکوب مخالفان] با سرکوب سریع و قاطع ایلات و خوانین متمرد، قدرت دولت مرکزی را به تمام نقاط کشور گسترش می‌دهم.", "effects": {"stability": 50, "military_strength": 10, "treasury": -150}, "next_node_id": None}
    ]
}
