...
INITIAL_DATA = {
    "dynasties": [
        {"id": 1, "name": "شاهنشاهی هخامنشی", "country": "ایران", "start_year": -550, "end_year": -330, "description": "نخستین امپراتوری جهانی که بر پایه حقوق بشر، تسامح دینی و یکپارچگی فرهنگی بنا نهاده شد.", "image_url": "/images/dynasties/achaemenid.jpg", "opening_brief": "سال ۵۵۹ پیش از میلاد. شما، کوروش، فرزند کمبوجیه یکم، شاه انشان، رهبری قومی را بر عهده گرفته‌اید که خراج‌گزار مادها هستند...", "start_decision_node_id": 1, "initial_resources": {"treasury": 800, "stability": 60, "military_strength": 120, "religious_influence": 50}},
        {"id": 2, "name": "شاهنشاهی اشکانی", "country": "ایران", "start_year": -247, "end_year": 224, "description": "سلسله‌ای که فرهنگ هلنیستی را با فرهنگ ایرانی درآمیخت و برای قرن‌ها سدی استوار در برابر امپراتوری روم بود.", "image_url": "/images/dynasties/parthian.jpg", "opening_brief": "سال ۲۴۷ پیش از میلاد. میراث اسکندر در حال فروپاشی است. سلوکیان، جانشینان یونانی او، بر سرزمین ایران حکمرانی می‌کنند، اما قدرتشان متزلزل است...", "start_decision_node_id": 2, "initial_resources": {"treasury": 600, "stability": 50, "military_strength": 150, "religious_influence": 30}},
        {"id": 3, "name": "شاهنشاهی ساسانی", "country": "ایران", "start_year": 224, "end_year": 651, "description": "آخرین شاهنشاهی بزرگ ایران باستان و احیاگر فرهنگ و دین زرتشتی که تأثیری عمیق بر تمدن اسلامی و جهان گذاشت.", "image_url": "/images/dynasties/sasanian.jpg", "opening_brief": "سال ۲۲۴ میلادی. شما، اردشیر بابکان، حاکم پارس، علیه اردوان چهارم، آخرین شاه اشکانی، قیام کرده است...", "start_decision_node_id": 3, "initial_resources": {"treasury": 1200, "stability": 65, "military_strength": 140, "religious_influence": 80}},
        {"id": 4, "name": "دولت صفوی", "country": "ایران", "start_year": 1501, "end_year": 1736, "description": "دولتی که با رسمی کردن مذهب تشیع، هویت ملی و مذهبی جدیدی به ایران بخشید و باعث احیای هنر و معماری شد.", "image_url": "/images/dynasties/safavid.jpg", "opening_brief": "سال ۱۵۰۱ میلادی. ایران‌زمین پس از قرن‌ها، تکه‌تکه و تحت حاکمیت‌های محلی است. شما، اسماعیل، نوجوانی سیزده ساله و رهبر طریقت صفوی، از تبعید بازگشته‌اید...", "start_decision_node_id": 4, "initial_resources": {"treasury": 500, "stability": 40, "military_strength": 90, "religious_influence": 90}},
        {"id": 5, "name": "دولت قاجار", "country": "ایران", "start_year": 1789, "end_year": 1925, "description": "دورانی از گذار ایران به دوران مدرن، مواجهه با قدرت‌های استعماری و آغاز جنبش‌های مشروطه‌خواهی.", "image_url": "/images/dynasties/qajar.jpg", "opening_brief": "سال ۱۷۹۴ میلادی. پس از آشوب‌های طولانی، شما، آقامحمدخان، رهبر ایل قاجار، سرانجام بر تمام رقبای داخلی پیروز شده‌اید...", "start_decision_node_id": 5, "initial_resources": {"treasury": 300, "stability": 35, "military_strength": 70, "religious_influence": 60}},
        {"id": 6, "name": "دولت پهلوی", "country": "ایران", "start_year": 1925, "end_year": 1979, "description": "عصر نوسازی سریع، تمرکزگرایی دولت، اصلاحات گسترده اجتماعی و اقتصادی و دگرگونی چهره ایران.", "image_url": "/images/dynasties/pahlavi.jpg", "opening_brief": "سال ۱۳۰۴ شمسی. مجلس مؤسسان به سلطنت قاجار پایان داده و شما، رضاخان، نخست‌وزیر قدرتمند، را به عنوان شاه جدید ایران انتخاب کرده است...", "start_decision_node_id": 6, "initial_resources": {"treasury": 400, "stability": 30, "military_strength": 80, "religious_influence": 20}}
    ],
    "decision_nodes": [
